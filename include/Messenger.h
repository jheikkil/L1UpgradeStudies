#ifndef MESSENGER_V8p2_21232
#define MESSENGER_V8p2_21232
...
#include "L1AnalysisPhaseIIDataFormatV8p2.h"
...
class L1PhaseIITreeV8p2Messenger;
...
public:   // Collections from the trees
   ...
   // vector<GenericObject> TkMuonStubS12;
...
public:
   L1PhaseIITreeV8p2Messenger(TFile &File, string TreeName = "l1PhaseIITree/L1PhaseIITree");
   ~L1PhaseIITreeV8p2Messenger();
   void SetBranchAddress();
   bool GetEntry(int Entry);
   vector<double> GetRegionFromEta(vector<double> &Eta);
   string Version() { return "V8p2"; }
