...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::L1Analysis::L1AnalysisPhaseIIDataFormat*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("L1Analysis::L1AnalysisPhaseIIDataFormat", "include/L1AnalysisPhaseIIDataFormatV8p2.h", 16,
...
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$include/L1AnalysisPhaseIIDataFormatV8p2.h")))  __attribute__((annotate("$clingAutoload$include/L1Classes.h")))  L1AnalysisPhaseIIDataFormat;}
)DICTFWDDCLS";
